...
<body>
    <div class="warning-container">
        ...
        <p class="warning-message">The minutes from the previous meeting have not yet been revised or corrected..</p>
        ...
        <div class="status-list">
            ...
            <div class="status-item">
                ...
                <span class="status-text">The minutes from the previous meeting have not yet been revised or corrected.
                Kindly make the necessary corrections and resubmit. Don’t worry—this version will be saved as a draft.</span>
            </div>
