...
<head>
    ...
    <title> Recreation Success</title>
...
<body>
    ...
    <div class="success-container">
        ...
        <p class="success-message">The revised version of the previous meeting minutes has been recorded successfully.</p>
        ...
        <div class="status-list">
            <div class="status-item">
                ...
                <span class="status-text">All the new changes have been added</span>
            </div>
            ...
            <div class="status-item">
                ...
                <span class="status-text">New Minute has created with the ID : <?=$minuteID?></span>
            </div>
        </div>
