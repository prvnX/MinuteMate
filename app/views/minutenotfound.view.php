...
<body>
    <div class="warning-container">
        ...
        <h1 class="warning-title">Oops!</h1>
        <p class="warning-message">Minute Not Found</p>
        ...
        <div class="status-list">
            ...
            <div class="status-item">
                ...
                <span class="status-text">The meeting minute you’re looking for could not be found in the system.</span>
            ...
            <div class="status-item">
                ...
                <span class="status-text">Please recheck the details and try again.</span>
