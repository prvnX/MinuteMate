...
<body>
    ...
    $profileDetails=["name"=>$_SESSION['userDetails'] -> username,"Email"=>$_SESSION['userDetails'] -> email,"LectureID"=>"932837273","NIC"=>$_SESSION['userDetails'] ->nic,"Role"=>" Student Rep","Contact_No:"=>"071 283 3684, 077 647 2983","Meeting_types"=>"IUD, RHD, Syndicate"]
   ?>
    </div>
    <div class="title">
    <h1>Your Profile</h1>
