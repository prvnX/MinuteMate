...
<body>
    ...
    <div class="warning-container">
        ...
        <h1 class="warning-title">Success</h1>
        <p class="warning-message">The Minute has been added, but we encountered an issue with email forwarding.</p>
        ...
        <div class="status-list">
            ...
            <div class="status-item">
                ...
                <span class="status-text">Email forwarding to departments was unsuccessful,Try it Manually </span>
            </div>
            <div class="status-item green-bg">
                <svg class="status-icon" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M5 13l4 4L19 7" />
